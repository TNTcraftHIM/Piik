...
$executablePath = Join-Path $outputPath 'piik-mf-h264-fixture.exe'
...
$compile = @(
    ...
    'cl.exe /nologo /c /std:c++20 /EHsc /W4 /WX /DPIIK_H264_FIXTURE /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /D_WIN32_WINNT=0x0A00 "{0}" /Fo:"{1}"' -f $sourcePath, $objectPath
