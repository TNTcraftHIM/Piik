// Modified by Piik: adapt the existing protocol tests to context-aware calls.
package natpmp
...
func (n *mockNetwork) call(_ context.Context, msg []byte, timeout time.Duration) (result []byte, err error) {
