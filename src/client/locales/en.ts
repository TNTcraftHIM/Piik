...
export const en: Record<CopyKey, string> = {
  ...
  "host.microphone.denied": "Microphone access was not allowed. Allow it in your browser and try again.",
  "host.microphone.unavailable": "The microphone is unavailable. Check its connection and browser permissions.",
