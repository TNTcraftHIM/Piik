...
export const en: Record<CopyKey, string> = {
  ...
  "host.sourcePicker.hint": "Use the Browser picker, or let Client capture a local window",
  "host.sourcePicker.browser": "Browser picker",
  "host.sourcePicker.browserHint": "Screen, window, or Browser tab",
  "host.sourcePicker.native": "Client window capture",
  "host.sourcePicker.window": "Share window: {title}",
  "host.sourcePicker.loading": "Finding local windows",
