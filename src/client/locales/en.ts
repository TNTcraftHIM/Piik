...
export const en: Record<CopyKey, string> = {
  ...
  "host.sourcePicker.cameraHint": "Share your camera, including from a phone",
  ...
  "host.device.permission.camera": "After sharing and allowing camera access, choose a camera here.",
