...
export const zh = {
  ...
  "client.launch.reopen": "请查看上方原因和黑窗口中的详细信息，关闭并重新打开 Piik 后重试。需要记录日志时，可先开启「诊断启动」。",
  "client.launch.debug": "诊断启动",
  "client.launch.debugHint": "本次启动记录 App 和网页诊断。App 日志可在黑窗口按 D 导出。",
  ...
  "host.policy.privateHint": "凭邀请链接加入；也可设置房间密码",
  ...
  "host.advanced.route.natPredictionUnavailable":
    "当前实例未启用额外 NAT 穿透；普通 P2P 连接仍可使用",
