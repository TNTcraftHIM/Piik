...
export const zh = {
  ...
  "host.sourcePicker.cameraHint": "分享摄像头画面，手机也可以使用",
  ...
  "host.device.microphone": "麦克风",
  "host.device.camera": "摄像头",
  "host.device.default": "默认设备",
  "host.device.missing": "所选设备暂不可用",
  "host.device.refresh": "刷新设备",
  "host.device.listFailed": "暂时无法获取设备，请刷新重试。",
  "host.device.permission.camera": "首次分享并允许访问后，可以在这里选择摄像头。",
  ...
  "host.microphone.browserOnly": "此采集方式暂不支持麦克风，可改用浏览器或摄像头。",
  "host.microphone.paused": "音视频分享已暂停，恢复后可开关麦克风。",
  "host.microphone.busy": "正在调整分享设置，请稍候。",
  "host.microphone.zeroVolume": "麦克风已开启，音量为 0%；点击可静音。",
  "host.shareControls": "分享控制",
  ...
  "host.sourcePicker.showCaptureBorder": "显示采集边框",
  "host.sourcePicker.showCaptureBorderHint": "关闭后尝试隐藏黄框；Windows 或其他采集程序可能仍要求显示。",
  "host.sourcePicker.empty": "暂无可用来源",
  "host.sourcePicker.unavailable": "未能连接 Piik App。请保持 App 运行，从 App 打开当前站点后刷新列表；浏览器询问本地网络权限时，请允许访问。",
  "host.sourcePicker.unsupported": "Piik App 采集功能当前不可用。请检查编码设置，或查看 App 诊断信息。",
  ...
  "host.capture.hasAudio": "含来源音频",
  "host.capture.noAudio": "无来源音频",
