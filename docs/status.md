...
- Production `screener-v3` admits private fragment grants directly; this atomic Web/Native source candidate uses `screener-v4`. Code-only Viewers need site access, and private rooms additionally need their password. Raw credentials are never stored.
