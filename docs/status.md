...
- `https://share.bonfire.icu` runs exact deployed application/runtime revision `2d5818ccf57f8ccf0999160ea74a16c9b4d97d12`, release `2d5818c`, wire `screener-v12`, from `/opt/screener/releases/2d5818c`; that revision is integrated in canonical `main`. Its immutable runtime ZIP SHA-256 is `a2e4c6b3bdf062103cd09b75c7de072eedcb8f311264070f57fbb0dfcf2bf315`, and its 38-file manifest SHA-256 is `eb118c51759e087bb81b530c7d765fd862220227d5f70bcf807628b61155b5f4`.
- `screener`, LiveKit, coturn, and nginx are active/running; local/public `/healthz` return 200, all six served Browser files match the immutable release, and all four services report `NRestarts=0`. The main Browser asset is `assets/index-CgT-8Ltd.js` with SHA-256 `f04c6ed8e963694a584b0e7de4bbf44820a7be1da10360a3ae99fb36149fb6be`; the prior asset returns 404.
- The service process resolves its working directory to exact release `2d5818c`; it has no writable room `StateDirectory` or SQLite runtime.
...
- Exact `main@2d5818c` passed repository hygiene, TypeScript, all 608 Web tests in 44 files, both production builds, focused independent review, and the production artifact/service postflight above. The predecessor SFU gate, access/privacy gate, 20-Viewer loopback, responsive visual, and physical SFU evidence remain separately revision-bounded in [verification status](./verification-status.md).
