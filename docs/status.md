...
- Mobile Web Host unsupported; Viewer leaf-only. Android 14+ direct-child video source lacks compile/device/SFU/audio/rotation proof; iOS deferred. TV output is local-only P2.
