...
- Web Host names are session-local. Deployed presence exposes each Viewer's exact active upstream for P2P/SFU details and an on-demand Host topology; presence remains control-plane-only.
