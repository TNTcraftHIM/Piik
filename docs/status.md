...
Complete the route production boundary without repeating the full local suite: one resource-limited
20-Viewer Browser smoke, production preflight, deploy, postflight, and rollback verification. The
dedicated LiveKit instance and measured SFU/TURN capacities remain required deployment inputs.
