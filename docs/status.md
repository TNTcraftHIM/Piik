...
- Focused tests cover initial/active Host ingress, peer last mile, one-use rollback, and STUN-only. Exact-source Chrome proves active TURN/UDP media, Viewer progress, Host edge one and stop zero; functional only.
