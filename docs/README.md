...
- [Verification status](./verification-status.md): exact integrated/deployed v9 gates, current production evidence, open physical proof boundaries, and expensive-test applicability.
...
- [Deployment](./deployment.md): exact current v9 production and rollback configuration, release operations, and transport evidence boundaries.
...
- [ADR-0005](./adr/0005-automatic-hybrid-media-routing.md): accepted and deployed v9 P2P-first single-reconcile route model; remaining real-network validation is tracked in verification status.
