...
- [Native H.264 hardware decision](./research/native-h264-hardware-decision.md): bounded WebCodecs H.264 hardware no-go, constraint/fmtp compatibility boundary, Pion Annex-B assessment, and the hardware-only Media Foundation next slice.
