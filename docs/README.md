...
- [ADR-0005](./adr/0005-automatic-hybrid-media-routing.md): accepted P2P-first single-reconcile route model; its core is deployed, Browser SFU ICE-server isolation is source-complete and production-pending, and real-network validation is tracked in verification status.
