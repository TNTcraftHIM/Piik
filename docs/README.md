...
- [Realtime quality adaptation](./research/realtime-quality-adaptation.md): fixed Browser VP8/no-video-hint evidence, manual quality ceilings, diagnostic-only capture/send/receive correlation, the single-`HIGH` decision, and rejected dual/SVC evidence.
...
- [ADR-0007](./adr/0007-path-isolated-representation-quality.md): accepted path-isolated single-`HIGH` Browser SFU representation, evidence contract, and rejected dual/SVC boundaries.
