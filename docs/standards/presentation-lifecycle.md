...
44px control height and all actions; the percentage readout hides on narrow
screens. If the control groups cannot fit, they wrap without overlapping.
Playing video hides the bar
