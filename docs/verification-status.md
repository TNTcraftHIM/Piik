...
- Chrome 151 synthetic `1/3/5/8` and 720p30 runs preserved bounded fanout and decoding. Sixteen-Viewer cap2/cap3 loopbacks decoded all Viewers and a ten-second follow-up recorded guarded sender and aggregate Chromium CPU evidence, but resolution/FPS remained low and the ordinary-PC data cannot rank the caps. These prove function, not sustainable capacity or heterogeneous-network quality, and do not change the production cap2 default. See [peer-assisted media](./research/peer-assisted-media.md).
