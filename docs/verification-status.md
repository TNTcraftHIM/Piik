...
- Relay resources: the deployed older release is Host2/Viewer2; current source policy is Host2/ordinary Browser Viewer1 and rejects any Viewer child2 regardless of advertised capacity. Relay CPU/GPU/upload cost and heterogeneous-network behavior remain unverified. Finish the role-aware matrix before the 20-viewer gate or any future capacity-tier change.
