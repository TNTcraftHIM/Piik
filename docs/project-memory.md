...
- Repository configuration can restrict peer assistance and LiveKit to exact `PEER_ASSISTED_ROOM_IDS`; unlisted rooms retain legacy P2P. Empty or missing means all rooms when enabled. Production predates and has not enabled this guard.
