...
- Mobile Web Host is unsupported. Android 14+ P1 uses MediaProjection and hardware-only libwebrtc children; SFU fails boundedly, while audio and rotation remain later. iOS waits for stable ScreenCaptureKit. TV output: P2, local-only; do not change routing or invent Cast transport.
...
- Production serves exact `5e4a3679076a9ea2fe7a41fadf4be65a439db450` at `https://share.bonfire.icu`. The immutable artifact is 909,974 bytes with SHA-256 `e484773c7dc381e657da18720e842c3ae90ad727320a650abcb1098428c74774`; the 2026-08-20T20:11:20Z UTC cutover held the deployment lock for 9,474 ms and reached local health in 676 ms from stop (529 ms from symlink switch). Exact `c27df2235ecc0be17816f642ca49028e30380a34` is the immediate rollback release.
