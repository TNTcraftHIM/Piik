...
- Source audio: route-consistent stereo; Viewer `stereo=1`; SFU 128 kbps stereo/`forceStereo`, DTX off, RED retained. Other SDP uses browser answer. Congestion/FEC and persistent stream stay intact. Production/audible proof open; no audio UI; voice stays separate. Native audio is source-only.
